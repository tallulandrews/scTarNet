...
Single-cell RNA sequencing is able to quantify the whole transcriptome from the small amount of RNA present in individual cells. 
...
library(doParallel)
library(parallel)
data <- readRDS("../data/minimalexData.rds")
...
Kolodziejczyk AA, et al. \textit{Cell Stem Cell}, 17(4):471-485, 2015. doi:10.1016/j.stem.2015.09.11, PMID: 26431182
